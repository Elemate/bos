           ...
           <table class="table-edit"  width="95%" align="center">
				...
				<tr class="title"><td colspan="4">其他信息</td></tr>
	           	<tr><td>工资:</td><td><input type="text" name="salary" id="salary" class="easyui-numberbox" /></td>
					<td>生日:</td><td><input type="text" name="myBirthday" id="birthday" class="easyui-datebox" /></td></tr>
	           	<tr><td>性别:</td><td>
				   ...
				   $(function () {
				       $.post("roleAction_listAjax",function (data) {
							for(var i=0; i<data.length; i++){
							    $("#associateRole").append('<input type="checkbox" value="'+data[i].id+'" name="roleIds" id="'+data[i].id+'"> <label for="'+data[i].id+'">'+data[i].name+'</label>')
							}
                       });
                   })
			   </script>

	           	<tr><td>关联角色:</td><td colspan="3" id="associateRole">  </td></tr>
           </table>
       </form>
