...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/highchart/highcharts.js"></script>
<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/highchart/modules/exporting.js"></script>
...
<script type="text/javascript">
	...
	function doShowSubarea() {
        ...
        $.post("subareaAction_findProvinceByGroup", function (data) {
            $("#showSubareaWindow").highcharts({
                chart: {
	...
	$(function(){
		...
		$("#save").click(function () {
			var v = $("#subareaSaveForm").form("validate");
			alert(v)
			if (v){
			    $("#subareaSaveForm").submit();
...
<body class="easyui-layout" style="visibility:hidden;">
	...
	<div class="easyui-window" title="分区添加修改" id="addSubareaWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
		...
		<div style="overflow:auto;padding:5px;" border="false">
			<form id="subareaSaveForm" action="subareaAction_save" method="post">
					...
					<tr>
						...
						<td>
							<input class="easyui-combobox" name="region.id"  
    							data-options="valueField:'id',textField:'provinceCityRegion',url:'regionAction_regionLists',mode:'remote'" />
						</td>
					</tr>
					<tr>
						<td>关键字</td>
